...
这是一个 14 天系列的文章和代码仓库，用 TypeScript/Node 从零实现一个 CLI 版 mini coding agent harness。

目标不是复刻 Cursor、Codex 或 Claude Code 的完整产品，而是拆开它们共同的工程骨架：context、tools、agent loop、patch、approval、rules 和 execution logs。
